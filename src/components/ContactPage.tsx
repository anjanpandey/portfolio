...
const ContactPage: React.FC = () => {
    ...
    if(error) {
        ...
        // define error 
        const errorVal: Modal = {id: "message-error", modalTitle: "Error", modalSize: "modal-sm", allowScrolling: false, isCentered: false, isDraggable: false, isLeftModal: false, isRightModal: false, onModalClose: removeErrorModal, style: {display:"block"}};
    ...
    // define button
    const submitButton : Button = {id: "btn-send-message", name: "Send", onClick: undefined, classes: "btn btn-success m-1", btnIcon: undefined, style: {}};
