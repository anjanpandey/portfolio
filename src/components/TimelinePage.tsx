...
const TimelinePage : React.FC = () => {
    // define timeline 
    const healcoveryTimeline: Timeline = {id: "timeline-healcovery", timelineTitle: "August 2024 - Present", timelineBadge: healcovery, timelineContent: "At healcovery, we've built a conversational AI named Casey that reduces avoidable ED visits, readmissions, and costs through proactive care coordination for patients with chronic and behavioral health conditions.", timelineLink: {name:"Visit healcovery", url:"https://www.healcovery.ai/"}};
