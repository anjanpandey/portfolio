...
const TimelinePage : React.FC = () => {
    // define timeline 
    const healcoveryTimeline: Timeline = {id: "timeline-healcovery", timelineTitle: "August 2024 - Present", timelineBadge: healcovery, timelineContent: "At healcovery, we've built a conversational AI named Casey for hospital case managers. Casey helps identify and address barriers, coordinates care, advocates for patients, and provides transitional support to patients. It helps case managers improve patient outcomes and reduce avoidable ED visits, readmissions, and costs. Every patient deserves a safe care transition. Together, let's bridge care gaps.", timelineLink: {name:"Visit healcovery", url:"https://www.healcovery.ai/"}};
