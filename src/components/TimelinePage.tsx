...
const TimelinePage : React.FC = () => {
    // define timeline 
    const healcoveryTimeline: Timeline = {id: "timeline-healcovery", timelineTitle: "August 2024 - Present", timelineBadge: healcovery, timelineContent: "Population Health Intelligence Platform for Proactive, Whole-Person Care", timelineLink: {name:"Visit healcovery", url:"https://www.healcovery.ai/"}};
