...
const TimelinePage : React.FC = () => {
    // define timeline 
    const healcoveryTimeline: Timeline = {id: "timeline-healcovery", timelineTitle: "August 2024 - Present", timelineBadge: healcovery, timelineContent: "At healcovery, our conversational AI, Casey, reduces avoidable ED visits and costs through proactive care coordination for hospital and health systems.", timelineLink: {name:"Visit healcovery", url:"https://www.healcovery.ai/"}};
