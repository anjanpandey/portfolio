...
const TimelinePage : React.FC = () => {
    // define timeline 
    const healcoveryTimeline: Timeline = {id: "timeline-healcovery", timelineTitle: "August 2024 - Present", timelineBadge: healcovery, timelineContent: "Intelligence for Population Health", timelineLink: {name:"Visit healcovery", url:"https://www.healcovery.ai/"}};
