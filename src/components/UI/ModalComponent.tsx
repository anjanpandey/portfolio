...
const ModalComponent: React.FC<Modal> = (props) => {
    ...
    const closeBtn: Button = {id: `btn-close-${props.id}`, name: "", classes: "btn-close", onClick: props.onModalClose,  btnIcon: undefined, style: {backgroundColor: isDarkTheme ? "#eeeeee": ""}};
